    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 px-4 py-6 pb-28 md:px-6 md:py-8">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <h2 className="text-3xl font-semibold tracking-tight text-slate-900">Your groups</h2>
          <p className="mt-3 text-sm leading-6 text-slate-600 md:text-base">
            View the event groups you have been placed into here.
          </p>
        </section>
      </div>

      <BottomNav currentView="groups" onNavigate={handleNavigate} />
    </main>
  );
}